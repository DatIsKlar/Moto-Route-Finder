...
public class ExportService
{
    ...
    {
        // Sample route geometry down to max 10 points for Google Maps URL limit
        var sampled = SampleForGoogleMaps(routeGeometry, maxPoints: 10);
    ...
    public bool OpenInGoogleMaps(Coordinate start, List<Coordinate> waypoints)
    {
        var url = GenerateGoogleMapsUrl(start, waypoints);
